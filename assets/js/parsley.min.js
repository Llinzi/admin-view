!function (t, e) {
    ...
    var f = function (t) {
        ...
        return function (t) {
            ...
            return i.pop(), !t || a.apply(void 0, [t].concat(u((r = s, i.map(d.parse[r])))));
            var r
        }
    }, g = function (t) {
        return {
    ...
    return h.listen = function (t, e) {
        var i;
        if (V(), "object" === r(arguments[1]) && "function" == typeof arguments[2] && (i = arguments[1], e = arguments[2]), "function" != typeof e) throw new Error("Wrong parameters");
        window.Parsley.on(M(t), O(e, i))
    }, h.listenTo = function (t, e, i) {
        if (V(), !(t instanceof b || t instanceof y)) throw new Error("Must give Parsley instance");
        ...
        min: "这个值应该大于或等于 to %s.",
        max: "这个值应该小于或等于 to %s.",
        range: "这个值应该在 %s and %s.",
        minlength: "这个值太短了. It should have %s characters or more.",
        maxlength: "This value is too long. It should have %s characters or fewer.",
        length: "此值长度无效. 应该在 %s and %s 字符.",
        mincheck: "你必须至少选择 %s.",
